  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg p-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-8 text-center">About EventiFy</h1>

        <div className="space-y-6 text-gray-700">
          <p className="text-lg leading-relaxed">
            Welcome to <span className="font-semibold text-primary">EventiFy</span>, your go-to platform for discovering, creating, and managing events. Whether you're looking to attend a local meetup, organize a conference, or host a social gathering, EventiFy makes it easy to connect with like-minded individuals.
          </p>
          ...
          <p className="text-lg leading-relaxed">
            Whether you're an event organizer or an attendee, EventiFy is here to make your experience seamless and enjoyable. Join our growing community today and start exploring the world of events!
          </p>
        </div>
      </div>
    </div>
